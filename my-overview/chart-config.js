var data_resources = {
  ...
  state_region_pop_age_gp: {
    ...
    download_link:
      "https://data.opendevelopmentmekong.net/dataset/7bc0cabc-3c01-44fe-ba30-943a360c56fb/resource/d646bd1e-f377-4152-a4a7-8785e2b39fc5/download/HouseholdspopulationBasedDatasetSRUnion.csv",
  },
  adminstration_list: {
    // id: "0393635f-79b9-4e6b-baff-e49e8a6e40d3",
    //id : '72f86e64-c434-4217-b002-bf439367b34d'
    // https://data.opendevelopmentmekong.net/km/api/3/action/datastore_search?resource_id=72f86e64-c434-4217-b002-bf439367b34d
...
var charts = {
  ...
  household: {
    ...
    usual_activity_10ab: {
      ...
      parents: [["UnEmployed", "Economically active", 0]],
    },
  },
  ...
  ts_election_lower_2010: {
    party_result: {
      chart_options: {
        title:
          "Votes obtained by party for Pyitthu Hluttaw, Myanmar General Election ,2010",
        isStacked: "percent",
        hAxis: {
          title: "Votes",
        },
  ...
  ts_election_lower_2012: {
    party_result: {
      chart_options: {
        title:
          "Votes obtained by party for Pyitthu Hluttaw, Myanmar by-elections, 2012",
        isStacked: "percent",
        hAxis: {
          title: "Votes",
        },
  ...
  ts_election_lower_2015: {
    party_result: {
      chart_options: {
        title:
          "Votes obtained by party for Pyitthu Hluttaw, Myanmar General Election, 2015",
        isStacked: "percent",
        hAxis: {
          title: "Votes",
        },
  ...
  st_election_2015: {
    party_result: {
      chart_options: {
        title:
          "Votes obtained by party for State/Region Parliament, Myanmar General Election, 2015",
        isStacked: "percent",
        hAxis: {
          title: "Seats",
        },
  ...
  revenue_expenditure: {
    revenue_expenditure: {
      ...
      columns: {
        ...
        "Governance and administration high court advocate general auditor general":
          "number",
        "Departments and DAOs28 ministries administrative departments and municipalities":
          "number",
...
var chartconfig = {
  ...
  ts_health_education: {
    resource: {
      ...
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/2f4131fa-04f3-4c25-a471-b8ebf53d92d3/resource/27a9753e-8453-4097-bec3-6e4929134e61",
  ...
  st_household: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/7bc0cabc-3c01-44fe-ba30-943a360c56fb/resource/d646bd1e-f377-4152-a4a7-8785e2b39fc5/download/HouseholdspopulationBasedDatasetSRUnion.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/7bc0cabc-3c01-44fe-ba30-943a360c56fb/resource/d646bd1e-f377-4152-a4a7-8785e2b39fc5",
  ...
  ts_household: {
    resource: {
      ...
      singlerow: true,
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/be760472-6224-4d73-b309-335d732cab93/resource/bc278a05-1ea9-4348-9352-9e14cd5ed8a3/download/HouseholdPopulationbaseddatasetMIMUTownshipsHouseholdAmenities.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/be760472-6224-4d73-b309-335d732cab93/resource/bc278a05-1ea9-4348-9352-9e14cd5ed8a3",
      dataset_id: "be760472-6224-4d73-b309-335d732cab93",
      filename:
        "HouseholdPopulationbaseddatasetMIMUTownshipsHouseholdAmenities.csv",
      resource_title: "2014 Myanmar population and housing census",
      filters: {
        pcode: "pcode_ts",
      },
  ...
  st_religion: {
    resource: {
      ...
      singlerow: true,
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/be760472-6224-4d73-b309-335d732cab93/resource/1edc5ad5-9e50-4a24-8fbe-fa35c3645e74/download/census2014stateregionreligion.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/be760472-6224-4d73-b309-335d732cab93/resource/1edc5ad5-9e50-4a24-8fbe-fa35c3645e74",
      dataset_id: "be760472-6224-4d73-b309-335d732cab93",
      filename: "census2014stateregionreligion.csv",
      resource_title:
        "2014 Myanmar population and housing census: Report on religion",
      filters: {
        pcode: "pcode",
      },
    },
  ...
  population_over_year: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/4046d3a9-0705-43af-b753-04b7b9af6e2f/resource/4b96995f-7b24-4b6f-b423-d149f9f2ab21/download/Area-and-Populatin-density-by-State-and-Region.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/4046d3a9-0705-43af-b753-04b7b9af6e2f/resource/4b96995f-7b24-4b6f-b423-d149f9f2ab21",
  ...
  election_result_lower_2010: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/7ab77f5e-778c-488a-b7fe-5dbce90ec6b7/resource/1d1859d8-5413-4c63-a89b-46a5787d7593/download/2010electionresultspyithu.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/7ab77f5e-778c-488a-b7fe-5dbce90ec6b7/resource/1d1859d8-5413-4c63-a89b-46a5787d7593",
  ...
  election_result_lower_2012: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/4d1e3e8d-4a62-4812-8e8b-5f5293aea320/resource/cfc49c33-8a78-4e7c-bfa9-35ade242e160/download/2012electionresultspyithu.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/4d1e3e8d-4a62-4812-8e8b-5f5293aea320/resource/cfc49c33-8a78-4e7c-bfa9-35ade242e160",
  ...
  election_result_lower_2015: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/ffc908b5-f13b-4085-8e77-3d0598ba6856/resource/43fd641a-35a9-4d6d-bfd0-8eabc52ca316/download/2015electionresultspyithu.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/ffc908b5-f13b-4085-8e77-3d0598ba6856/resource/43fd641a-35a9-4d6d-bfd0-8eabc52ca316",
  ...
  state_region_election_2015: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/4bbcff3a-b480-406a-8882-86d82655bcf1/resource/617724b4-351c-4d9c-b6dd-88fcc0495869/download/Election-Results-for-State-and-Region-Seats.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/4bbcff3a-b480-406a-8882-86d82655bcf1/resource/617724b4-351c-4d9c-b6dd-88fcc0495869",
  ...
  revenue_expenditure: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/c6778dfe-836f-48ad-9812-d1d27acce3cc/resource/7dcb30ad-75cf-4339-af6c-290683d904f5/download/stateregionsexprev.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/myanmar-state-and-region-expenditure-and-revenue/resource/7dcb30ad-75cf-4339-af6c-290683d904f5",
  ...
  tree_cover: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/95dec5d5-a328-47b6-a5e1-0a3d798f5650/resource/74c7dea8-e8ee-49ad-b946-b4dda2d6e20f/download/tree-cover-combined.csv",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/tree-cover-data-from-global-forest-watch/resource/74c7dea8-e8ee-49ad-b946-b4dda2d6e20f",
  ...
  health_life_expectancy: {
    resource: {
      ...
      download_link:
        "https://data.opendevelopmentmekong.net/dataset/493e50f6-de0d-46aa-89ce-975e6a964af7/resource/01f16e66-0280-44cc-b728-90d362b450cc/download/2014-Census-Health.xlsx",
      resource_link:
        "https://data.opendevelopmentmekong.net/dataset/the-levels-of-cbr-tfr-and-total-marital-fertility-rates-tmfr-by-state-region-and-childhood-mortalit/resource/01f16e66-0280-44cc-b728-90d362b450cc",
    ...
    charts: {
      ...
      mortality_rate: {
        ...
        fields: [["Mortality rate", "imr", "u5mr"]],
      },
    },
  },
};
